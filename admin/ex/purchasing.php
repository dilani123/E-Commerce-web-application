            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                   <tr>
                    <td>15/04/2020</td>
                    <td>Mr.Amal Dikkubura</td>
                            <td><img src="images/profile.jpg" height='30px' width='30px'><br>
                            Pink Roses with 100 flowers</td>
                            
                            <td>$20</td>
                            <td>"071-0117456"<br>No 453/9,Pallegama, Embilipitiya</td>
